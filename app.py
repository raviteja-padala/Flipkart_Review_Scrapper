            ...
            for link in links:
                ...
                for commentbox in commentboxes[0:8]:
                    try:
                        ...
                        name = 'No Name'
                    try:
                        logging.info("Getting Price of Product")
                    ...
                    try:
                        logging.info("Getting Review Date")
                        reviewDate = commentbox.div.find_all('p', {'class': '_2sc7ZR'})[1].text
                    except Exception as e:
                        raise CustomException(e,sys)
                    logging.info("Creating a dictionary to store all the data for each product")
                    mydict = {"Product": searchString, "Price": price, "Reviewer Name": name, "Rating": rating, "CommentHead": commentHead,
                          "Comment": custComment, "ReviewDate": reviewDate}
